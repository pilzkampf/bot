...
With the `/alarm` command, you can set a new mushroom alert, edit the list of your mushroom alerts, or turn the [notifications](userconfig.md#mushroom-alert) on and off.
